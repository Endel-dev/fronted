                              ...
                              children: [
                                  ...
                                  onTap: () async {
                                    ...
                                    if (pickedDate != null) {
                                      ...
                                      if (_isUserUnderage(pickedDate)) {
                                        // Show a Toast message if the user is underage
                                ...
                                Row(
                                  ...
                                  children: [
                                    ElevatedButton(
                                      onPressed: () {
                                        if (registrationKey1.currentState!.validate() && registration.dobController.text != "" ) {
                                        ...
                                        {
                                          Fluttertoast.showToast(msg: "Please! Enter all details",backgroundColor: Colors.red,textColor: Colors.white);
                                        }
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  ButtonCommon(
                                    ...
                                    onTap: () async {
                                      if (registration.registrationKey.currentState!.validate()) {
                                        // Show loading dialog
                                        showDialog(
                                          context: context,
                                        ...
                                        final taskData = {
                                          ...
                                          "password": registration.passwordController.text,
                                          "name": "${registration.firstNameController.text} ${registration.lastNameController.text}",
                                          "dob": registration.dobController.text,
                                          "gender": registration.gender,
                                          "role": "parent",
                                          "phoneNumber": registration.phoneNumberController.text,
                                          "address1": registration.addLine1Controller.text,
                                          "address2": registration.addLin2Controller.text,
                                          "address3": registration.addLin2Controller.text,
                                          "city": registration.cityController.text,
                                          "state": registration.stateController.text,
                                          "pinCode": registration.pincodeController.text,
                                          "firstName": registration.firstNameController.text,
                                          "lastName": registration.lastNameController.text,
                                        };
