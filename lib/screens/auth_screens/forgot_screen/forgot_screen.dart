                      ...
                      Column(
                          ...
                          children: [
                            ...
                            ButtonCommon(
                                ...
                                onTap: () {
                                  if(forgot.emailTextController.text.isEmpty){
                                    Fluttertoast.showToast(msg: "Please Enter Your correct Email ID",
                                    backgroundColor: Colors.red,textColor: Colors.white,gravity: ToastGravity.CENTER);
                                  }else
                                    {

                                      Forgot_password(forgot.emailTextController.text,context);
                                    }
